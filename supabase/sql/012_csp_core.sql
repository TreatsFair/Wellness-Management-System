...
begin
  ...
  where appointment_group_id = p_appointment_group_id;
...
grant execute on function public.create_appointment_group_with_csp(uuid, text, integer, date, jsonb, text, text, uuid) to authenticated;
grant execute on function public.update_appointment_group_with_csp(uuid, uuid, text, integer, date, jsonb, text, text, uuid) to authenticated;
