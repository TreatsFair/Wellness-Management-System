...
begin
  ...
  -- Only checkout_appointment*_with_payment sets this local flag, after a
  -- staff override for a late-arrival extension conflict.
...
drop function if exists public.checkout_appointment_group_with_payment(
